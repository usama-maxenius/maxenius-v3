      ...
      <div className="bg-blue-900 w-full">
        ...
        <h5
          className={`
            ...
            ${theme.colors.brand.accent} 
            leading-[28px] font-semibold mb-10
          `}
        >
          AsteraBytes!
        </h5>
        ...
        <p
          className={`
            ...
            ${theme.colors.brand.accent} 
            leading-[25px] font-normal mb-10 
            w-full sm:w-[90%]
          `}
        >
