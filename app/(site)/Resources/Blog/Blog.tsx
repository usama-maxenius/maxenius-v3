...
const Blog = () => {
  return (
   <section className={`${theme.spacing.section} bg-black`}>
    <div className= {`${theme.spacing.container} mx-auto flex flex-col items-center justify-center gap-6 mt-100`}>
    <h1 className={`${theme.typography.heading.h0} ${theme.colors.brand.accent} font-semibold leading-[100px] mb-20`}>NEWS & BLOG</h1>
    <p className={`${theme.colors.brand.accent} ${theme.typography.paragraph.p2} leading-[35px] font-normal text-center w-[52%] mb-10`}>Lorem ipsum dolor sit amet consectetur. Vel elementum egestas eu faucibus. Nibh fringilla sociis.Lorem ipsum dolor sit amet consectetur.  </p>
