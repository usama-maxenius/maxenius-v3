...
const Max = () => {
  return (
    ...
    style={{
        ...
        <div className={`${theme.spacing.container} mx-auto text-center pb-170 ${theme.spacing.section}`}>
            <h1 className={`${theme.colors.brand.accent} font-semibold ${theme.typography.heading.h3} lg:${theme.typography.heading.h0} pt-[55px] leading-[94px]`}>MAX Inventory</h1>
            <p className={`${theme.typography.paragraph.p3} ${theme.colors.brand.accent} font-medium leading-[30px] mx-auto pt-[35px] w-[51%] `}>Lorem ipsum dolor sit amet consectetur. Orci amet sit habitasse gravida. Tincidunt semper gravida dui nunc. Quam et orci elit tincidunt. </p>
