...
import AnotherPage from "./newSlider"

const Portfolio = () => {
  return (
    <section
      className={`w-full items-center overflow-hidden  py-10`}
    ...
    >
      {/* Header */}
      <div className={`mt-20 text-start  lg:text-center px-6 ${theme.spacing.scontainer} `}>
        <p
