...
const AboutProject = () => {
  ...
  {/* 01 / CHALLENGE */}
  <div className="relative flex flex-col lg:flex-row justify-center items-center lg:gap-[161px] border-b border-gray-800 pb-20">
    {/* Number & Title Block */}
    <div className=" flex  items-center justify-center">
      ...
      {/* Foreground text */}
      <p  className={`${theme.typography.paragraph.p1} ${theme.colors.brand.accent} leading-[31px] font-semibold absolute top-1/12 lg:top-1/5 -translate-y-1/2 left-1/3 lg:left-[0px] z-10`}>
        CHALLENGE
      </p>
    </div>
  ...
  {/* 02 / APPROACH */}
  <div className="relative flex flex-col lg:flex-row justify-center items-center lg:gap-[136px] mt-10 border-b border-gray-800 pb-20">
    <div className="flex  items-center justify-center">
      <p className="font-semibold text-[134.11px] leading-[173.23px] bg-gradient-to-b from-[#3B3B3B] to-[#0F0F0F] bg-clip-text text-transparent opacity-50 select-none relative z-0">
        02
      </p>
